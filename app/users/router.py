...
from app.common.security import encrypt_api_key, generate_key_fingerprint
from app.users.model import User, UserAPIKey
from app.users.schema import UserCreate, UserResponse, UserAPIKeyCreate, UserAPIKeyResponse
...
@router.post("/keys", response_model=UserAPIKeyResponse, status_code=status.HTTP_201_CREATED, summary="Encrypt & store third-party BYOK API key")
